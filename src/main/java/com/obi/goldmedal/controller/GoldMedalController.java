package com.obi.goldmedal.controller;

import com.obi.goldmedal.model.*;
import com.obi.goldmedal.repositories.*;
    ...
    private CountryMedalsListResponse getCountryMedalsListResponse(String countryName, String sortBy, boolean ascendingOrder) {
        ...
        switch (sortBy) {
            case "year":
                ...
                break;
            case "season":
                medalsList = ascendingOrder ? goldMedalRepository.getByCountryOrderBySeasonAsc(countryName) : goldMedalRepository.getByCountryOrderBySeasonAsc(countryName);
                break;
            case "city":
